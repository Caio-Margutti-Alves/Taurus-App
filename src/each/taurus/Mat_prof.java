...
public class Mat_prof extends Activity {

	private String url_reserva = "http://10.0.2.2/android_connect/reservas.php?prof=";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String sala = extras.getStringExtra("id_usuario");
		url_reserva += sala;
