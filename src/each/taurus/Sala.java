...
public class Sala extends Activity {
	...
	private String url_sala = "http://10.0.2.2/android_connect/getsala.php?predio="; //Url com a variavel necessária pra pesquisa php daquele dado
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String predio = extras.getStringExtra("id_predio");
		url_sala += predio; 	//Acrescenta na String que indica o php correspondente
		...
		lista.setOnItemClickListener( new OnItemClickListener() { //Parte que bota oq acontece se o user clica num item.
		    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		        String sala = ids[(int) id];
		        pesquisa_reservas(sala);
		    }});
	 }
	...
	public void pesquisa_reservas(String in){
		Intent reserva = new Intent(Sala.this,Reservas_sala.class); //Passa o id, ou nome da sala pro próximo Activity
        reserva.putExtra("id_sala",in);
        Sala.this.startActivity(reserva);    
	}
}
